...
mods.tconstruct.Casting.removeTableRecipe(gearChalcedony);
mods.tconstruct.Smeltery.removeMelting(gearChalcedony);
...
mods.amt.Plate.removeRecipe(<minecraft:slime_ball>);
furnace.remove(<minecraft:slime_ball>);

//Remove Leather Recipe
mods.amt.Plate.removeRecipe(<minecraft:leather>);
